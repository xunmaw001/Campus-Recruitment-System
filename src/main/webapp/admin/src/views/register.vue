  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(229, 238, 229, 0.07);borderRadius:10px">
        <h1 class="h1" style="color:rgba(24, 103, 228, 1);fontSize:28px;">校园招聘系统注册</h1>
...
export default {
  ...
  methods: {
    ...
    login() {
      ...
      if((!this.ruleForm.lianxidianhua) && `qiye` == this.tableName){
      ...
      if((!this.ruleForm.qiyeyouxiang) && `qiye` == this.tableName){
