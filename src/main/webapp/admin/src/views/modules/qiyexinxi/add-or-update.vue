  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.qiyebianhao" label="企业编号" prop="qiyebianhao">
              <el-input v-model="ruleForm.qiyebianhao" 
                placeholder="企业编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="企业性质" prop="qiyexingzhi">
          <el-input v-model="ruleForm.qiyexingzhi" 
              placeholder="企业性质" clearable  :readonly="ro.qiyexingzhi"></el-input>
        </el-form-item>
        <div v-else>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.xiangqing = this.ruleForm.xiangqing.replace(reg,'../../../ssmb9475/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
