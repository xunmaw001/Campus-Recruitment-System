    ...
    >
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="需求职位" prop="xuqiuzhiwei">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="需求职位"
                  v-model="ruleForm.xuqiuzhiwei" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xuqiuzhiwei" label="需求职位" prop="xuqiuzhiwei">
                    <span>{{ruleForm.xuqiuzhiwei}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="待遇要求" prop="daiyuyaoqiu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="待遇要求"
                  v-model="ruleForm.daiyuyaoqiu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.daiyuyaoqiu" label="待遇要求" prop="daiyuyaoqiu">
                    <span>{{ruleForm.daiyuyaoqiu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.gerenjianjie = true;
          ...
          if(o=='xuqiuzhiwei'){
            this.ruleForm.xuqiuzhiwei = obj[o];
	    this.ro.xuqiuzhiwei = true;
            continue;
          }
          if(o=='daiyuyaoqiu'){
            this.ruleForm.daiyuyaoqiu = obj[o];
	    this.ro.daiyuyaoqiu = true;
            continue;
          }
          if(o=='shouji'){
	...
	this.ruleForm.gerenjianjie = this.ruleForm.gerenjianjie.replace(reg,'../../../ssmb9475/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
