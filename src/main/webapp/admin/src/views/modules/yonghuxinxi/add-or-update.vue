<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="专业" prop="zhuanye">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.zhuanye" label="专业" prop="zhuanye">
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="毕业日期" prop="biyeriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.biyeriqi" label="毕业日期" prop="biyeriqi">
              <el-input v-model="ruleForm.biyeriqi" 
                placeholder="毕业日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="协议书编号" prop="xieyishubianhao">
          <el-input v-model="ruleForm.xieyishubianhao" 
              placeholder="协议书编号" clearable  :readonly="ro.xieyishubianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="协议书编号" prop="xieyishubianhao">
              <el-input v-model="ruleForm.xieyishubianhao" 
                placeholder="协议书编号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.biyeriqi = true;
          ...
          if(o=='xieyishubianhao'){
            this.ruleForm.xieyishubianhao = obj[o];
	    this.ro.xieyishubianhao = true;
            continue;
          }
          if(o=='fujian'){
      ...
      this.$http({
		...
		if(json.xingming!=''&&json.xingming){
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              url: `option/yuanxifenlei/leixing`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
